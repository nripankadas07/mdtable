        ...
        mdtable exists to solve a narrow, inspectable developer-tooling problem:
        Render GFM Markdown tables from headers + rows with strict pipe escaping and per-column alignment. Zero dependencies.
        ...
        Topics: gfm, markdown, python, tables, zero-dependencies

        ## Current Gates

        - Latest completed CI: success
        - Source files counted by audit: 1
